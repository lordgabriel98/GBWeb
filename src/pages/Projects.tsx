...
function Projects(){
        ...
        <motion.section initial={{opacity:0, y:24}} animate={{opacity:1, y:0}} transition={{duration: 0.8, ease: "easeOut"}}
            ...
            <h4 className="text-sm text-teal-700 font-semibold mb-4 tracking-widest uppercase relative dark:text-teal-500">Work</h4>
            <h2 className="text-5xl mb-10 font-bold">
                Projects
            </h2>
            <p className="text-gray-500 max-w-2xl dark:text-white">
