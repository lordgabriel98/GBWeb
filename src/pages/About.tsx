        ...
        <>
         <motion.section initial={{opacity:0, y:24}} animate={{opacity:1, y:0}} transition={{duration: 0.8, ease: "easeOut"}}
          className="mx-auto px-6 py-24 px-6 sm:px-10 md:px-16 lg:px-24 xl:px-40 py-5">
            <h4 className="text-sm text-teal-700 font-semibold mb-4 tracking-widest uppercase relative dark:text-teal-500">About</h4>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-15">
                <div>
                    ...
                    <p className="text-black-500 max-w-2xl mb-5 dark:text-white">
                    ...
                    <p className="text-gray-500 max-w-2xl mb-5 dark:text-olive-300">
                    ...
                    <p className="text-gray-500 max-w-2xl dark:text-olive-300">
