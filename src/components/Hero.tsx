...
function Hero(){
    ...
    return (
        <motion.section initial={{opacity:0, y:24}} animate={{opacity:1, y:0}} transition={{duration: 0.8, ease: "easeOut"}} className="mx-auto px-6 py-24 px-6 sm:px-10 md:px-16 lg:px-24 xl:px-40 py-5">
            <h4 className="text-sm text-teal-700 font-semibold mb-4 tracking-widest uppercase relative dark:text-teal-500">Software Developer</h4>
        ...
        <div className= "flex flex-row items-start gap-10 mb-3">
                ...
                <Link className="border-1 border-gray-200 px-4 py-2 rounded-lg text-sm hover:bg-slate-50 dark:hover:bg-slate-600" to="/contact"> Get in Touch </Link>
            
        </div>
        <div className="flex flex-row gap-10 py-4">
          <a href="https://github.com/lordgabriel98/">
            <LuGithub className="text-gray-500 hover:text-slate-900 dark:text-white hover:text-teal-300"/>
          </a>
          <a href="https://www.linkedin.com/in/gabriel-baje-166b571aa/">
            <LuLinkedin className="text-gray-500 hover:text-slate-900 dark:text-white hover:text-teal-300"/>
          </a>

          <a href="mailto:bajegabriel@gmail.com">
            <HiOutlineEnvelope className="text-gray-500 hover:text-slate-900 dark:text-white hover:text-teal-300"/>
          </a>
        </div>
